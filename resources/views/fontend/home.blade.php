            ...
            <div class="row service-wrap mr-0 ml-0">
                <div class="col-lg-4 padding-0">
                    <div class="service-grid">
                        ...
                        <div class="btn-wrap">
                            <a class="readmore" href="{{route('design-consultancy-services')}}">Read more <div class="btn-arrow"></div></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 padding-0">
                    <div class="service-grid">
                        ...
                        <div class="btn-wrap">
                            <a class="readmore" href="{{route('fire-electrical-solution')}}">Read more <div class="btn-arrow"></div></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 padding-0">
                    <div class="service-grid br-none bdru">
                        ...
                        <div class="btn-wrap">
                            <a class="readmore" href="{{route('automation-solution')}}">Read more <div class="btn-arrow"></div></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row service-wrap mr-0 ml-0">
                <div class="col-lg-4 padding-0 pr-1">
                    <div class="service-grid">
                        ...
                        <div class="btn-wrap">
                            <a class="readmore" href="{{url('electrical-safety-audits-2')}}">Read more <div class="btn-arrow"></div></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 padding-0">
                    <div class="service-grid">
                        ...
                        <div class="desc mb-12">Integer at faucibus urna. Nullam condimentum leo id.</div>
                        <div class="btn-wrap">
                            <a class="readmore" href="{{url('noc-no-objection-certificate')}}">Read more <div class="btn-arrow"></div></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 padding-0">
                    <div class="service-grid">
                        ...
                        <div class="desc mb-12">Integer at faucibus urna. Nullam condimentum leo id.</div>
                        <div class="btn-wrap">
                            <a class="readmore" href="{{url('busbar-trunking-bbt-systems')}}">Read more <div class="btn-arrow"></div></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 padding-0 pr-1">
                    <div class="service-grid">
                        ...
                        <div class="desc mb-12">Integer at faucibus urna. Nullam condimentum leo id.</div>
                        <div class="btn-wrap">
                            <a class="readmore" href="{{url('active-fire-protection-systems')}}">Read more <div class="btn-arrow"></div></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 padding-0">
                    <div class="service-grid">
                        ...
                        <div class="desc mb-12">Integer at faucibus urna. Nullam condimentum leo id.</div>
                        <div class="btn-wrap">
                            <a class="readmore" href="{{url('lightning-protection-system-lps-design')}}">Read more <div class="btn-arrow"></div></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 padding-0">
                    <div class="service-grid">
                        ...
                        <div class="desc mb-12">Integer at faucibus urna. Nullam condimentum leo id.</div>
                        <div class="btn-wrap">
                            <a class="readmore" href="{{url('hotel-automation-systems')}}">Read more <div class="btn-arrow"></div></a>
                        </div>
                    </div>
                </div>
            </div>
